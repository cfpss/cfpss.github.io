function [idxfilter, Sphcoord_leaf_filt,Sphcoord_leafnorm_filt,R_sonar_leaf_filt,leaf_dia_filt,sonarbp_gain,Sonargain_filt,Incident_angles] = filter_leaves_beamG (echo_param,Sphcoord_sonar,Sphcoord_leaf,TH_leaf_norm, PHI_leaf_norm, R_leaf_norm,leaf_dia,peakAmp, freqorbmwdth,beam_rot,freqorbmwdthVal , beamcenter)
...
noise = [];
Zgain_sonar_emission = gauss_beam_sonar(Sonaramp,freqorbmwdth,freqorbmwdthVal,beamcenter,beam_rot,noise);
